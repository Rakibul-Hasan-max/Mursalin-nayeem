    ...
    <div className="flex min-h-screen bg-[#F6F7FB] font-sans">
      ...
      <main className="flex-1 ml-0 lg:ml-[280px] flex flex-col items-center justify-center min-h-screen px-6 py-20 lg:p-0">
        <div className="flex flex-col items-center -mt-10">
          ...
          <div className="relative w-[240px] h-[240px] sm:w-[280px] sm:h-[280px] rounded-full p-2 bg-white/40 shadow-[0_8px_30px_rgba(0,0,0,0.04)] mb-8 flex items-center justify-center">
